    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: _lightPrimary.withValues(alpha: 0.3), width: 2),
        ),
      ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style:
            ElevatedButton.styleFrom(
              ...
              shadowColor: _lightPrimary.withValues(alpha: 0.6),
              elevation: 12,
            ).copyWith(
              overlayColor: WidgetStateProperty.all(
                _lightPrimary.withValues(alpha: 0.2),
              ),
            ),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: _lightBorderMedium.withValues(alpha: 0.3)),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: _lightBorderLight.withValues(alpha: 0.5)),
        ),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(16),
          side: BorderSide(color: _darkPrimary.withValues(alpha: 0.2), width: 1),
        ),
      ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style:
            ElevatedButton.styleFrom(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
              shadowColor: _darkPrimary.withValues(alpha: 0.6),
              elevation: 12,
            ).copyWith(
              overlayColor: WidgetStateProperty.all(
                _darkPrimary.withValues(alpha: 0.2),
              ),
            ),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: _darkBorderMedium.withValues(alpha: 0.4)),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: _darkBorderLight.withValues(alpha: 0.6)),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
