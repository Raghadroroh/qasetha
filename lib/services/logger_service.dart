...
class LoggerService {
  ...
  static void info(String message, {String? name, Object? error}) {
    developer.log(message, name: name ?? _appName, level: 800, error: error);
  }

  static void warning(String message, {String? name, Object? error}) {
    developer.log(message, name: name ?? _appName, level: 900, error: error);
  }
  ...
  static void debug(String message, {String? name, Object? error}) {
    developer.log(message, name: name ?? _appName, level: 700, error: error);
  }
}
